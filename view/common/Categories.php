<div class="col-md-2">
	<div class="list-group">
		...
		<a href="products.php?op=list&cat=1" class='list-group-item'>Antiques
			<span class='badge'>1</span></a>
		<a href="products.php?op=list&cat=2" class='list-group-item'>Arts
		...
		<a href="products.php?op=list&cat=6" class='list-group-item'>Electronic
